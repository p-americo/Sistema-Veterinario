...
@Service
public class MedicamentoServiceImplement extends GenericCrudServiceImplement<Medicamento, Long, MedicamentoRequestDTO, MedicamentoResponseDTO> implements  MedicamentoService {
    ...
    public MedicamentoResponseDTO criar(MedicamentoRequestDTO dto) {
        ...
        novoProduto.inicializarEstoque(dto.getQuantidadeEstoque());
